...
<body>
	...
	%>
	<h2>회원 가입</h2>
    <form action="json.do" method="post">
        ...
        <input type="text" id="userId" name="userId" placeholder="닉네임 입력" required><br><br> -->
        ...
        <input type="checkbox" id="interest1" name="interest" value="공상과학">
        <label for="interest1">SF 판타지</label><br>
        <input type="checkbox" id="interest2" name="interest" value="판타지">
        <label for="interest2">판타지</label><br>
        <input type="checkbox" id="interest3" name="interest" value="스팀펑크">
        <label for="interest3">스팀 펑크</label><br>
        <input type="checkbox" id="interest4" name="interest" value="사이버펑크">
        <label for="interest4">사이버 펑크</label><br>
        <input type="checkbox" id="interest4" name="interest" value="없음" checked>
        <label for="interest5">관심 분야 없음</label><br><br>

...
<body>
   ...
   <form action="register" method="POST">
      ...
      <input type="text" name="userId" placeholder="아이디 입력"
         required="required">    
      <p>패스워드</p>
      <!-- input password : request parameter의 password -->
         <input type="password" name="password" placeholder="비밀번호 입력"
         required="required">    
      <p>이메일</p>
      <!-- input email : request parameter의 email -->
         <input type="email" name="email" placeholder="이메일 입력"
         required="required">    
      <p>이메일 수신여부</p>
      <!-- input emailAgree : request parameter의 emailAgree -->
        <input type="radio" name="emailAgree" value="yes">예
      	<input type="radio" name="emailAgree" value="no" checked="checked">아니오         
      <p>자기소개</p>
      <!-- input introduce : request parameter의 introduce -->
